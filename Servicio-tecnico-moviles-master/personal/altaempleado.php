...
{
	$sql = "INSERT INTO persona(dni_o_cif, tipo, nombre, apellidos, telefono, direccion) VALUES ('$nifEmpleado','Cliente', '$nombreEmpleado', '$apellidosEmpleado', '$telefonoEmpleado', '$direccionEmpleado')";
